					...
					<div className='-mx-4 flex flex-wrap'>
						<div className='w-full px-4 sm:w-2/3 lg:w-3/12'>
							<div className='mb-10 w-full'>
								...
								<p className='flex items-center text-sm font-medium text-dark dark:text-white'>
									<span className='mr-3 text-primary text-white'>
										<svg
											width='20'
											height='20'
											viewBox='0 0 20 20'
									...
									<span className='text-white'>+628-1500-0000</span>
								</p>
							</div>
						</div>

						<LinkGroup header='Product' className='text-white'>
						...
						<div className='w-full px-4 sm:w-1/2 lg:w-3/12'>
							<div className='mb-10 w-full'>
								...
								<p className='text-white text-body-color '>&copy; 2025 YXZ</p>
							</div>
						</div>
					</div>
				</div>
		...
		<>
			<div className='w-full px-4 sm:w-1/2 lg:w-2/12'>
				<div className='mb-10 w-full'>
					...
					<ul className='space-y-3 text-white'>{children}</ul>
				</div>
			</div>
		</>
	);
...
const NavLink = ({ link, label }) => {
	return (
		<li>
			<a
				href={link}
				className='inline-block text-base leading-loose text-white hover:underline'
			>
				{label}
			</a>
		</li>
