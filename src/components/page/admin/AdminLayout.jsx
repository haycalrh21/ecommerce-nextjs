 ...
 * @see https://v0.dev/t/LfKIuSbyuID
	...
	return (
		<div className='grid min-h-screen w-full md:grid-cols-[220px_1fr] lg:grid-cols-[280px_1fr]'>
			...
			<div className='flex flex-col overflow-x-scroll'>
				<header className='flex items-center justify-between h-14 lg:h-20 px-4 lg:px-6 bg-gray-200 border-b'>
					<Sheet>
						...
						>
							<nav className='grid gap-2 text-lg font-medium'>
								...
								<Link href='/admin/order' passHref>
									<div className='flex items-center gap-4 rounded-xl px-3 py-2 hover:text-blue-600 cursor-pointer'>
					...
					<form className='flex-1 ml-4'>
						<div className='relative'>
							...
							<Input
								...
								className='w-full bg-gray-100 pl-8 shadow-none'
							/>
						</div>
					</form>
					<DropdownMenu>
